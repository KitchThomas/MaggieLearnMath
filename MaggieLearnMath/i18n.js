...
const i18n = {
  ...
  translations: {
    en: {
      ...
      nextWord: 'Next Word',
      perfect: 'Perfect! First try!',
      gotIt: 'Got it! Used {attempts} attempts.',
      ...
      // Word Import
      importWords: 'Import Words / 导入单词',
      manualInput: 'Manual Input / 手动输入',
      listName: 'List Name / 列表名称',
      selectLanguage: 'Language / 语言',
      wordInput: 'Add Words / 添加单词',
      enterWord: 'Enter word',
      enterDefinition: 'Enter definition',
      enterExample: 'Enter example sentence',
      wordList: 'Word List / 单词列表',
      words: 'words',
      noWordsYet: 'No words added yet / 还没有添加单词',
      foundWords: 'Found',
      ...
      myCustomLists: 'My Custom Lists / 我的自定义列表',
      importCustomList: 'Import Custom List / 导入自定义列表',
      manageLists: 'Manage Lists / 管理列表',
    },
    ...
    fr: {
      ...
      perfect: 'Parfait! Premier essai!',
      gotIt: 'Bien! {attempts} essais!',
      wrong: 'Pas tout à fait. Essayez encore!',
