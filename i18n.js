...
const i18n = {
  ...
  translations: {
    en: {
      ...
      // Sentence dictation
      sentenceDictationTitle: 'Sentence Dictation',
      wordDictationDesc: 'Word spelling practice',
      sentenceDictationDesc: 'Listen and write full sentences',
      sentence: 'Sentence',
      hearSentence: 'Hear Sentence',
      typeSentence: 'Type the sentence you heard...',
      sentenceCount: 'Number of Sentences',
      hintLevel: 'Hint Level',
      hintLevel1: 'This sentence has {count} words',
      playSpeed: 'Speed',
      slow: 'Slow',
      accuracyScore: 'Accuracy',
      partialCredit: 'Almost! {accuracy}% correct',
      sentenceReview: 'Sentence Review',
      averageAccuracy: 'Average Accuracy',
      charactersCorrect: 'characters correct',
    ...
    zh: {
      ...
      // 听写句子练习
      sentenceDictationTitle: 'Dictée de phrases',
      wordDictationDesc: 'Pratique d\'orthographe',
      sentenceDictationDesc: 'Écoutez et écrire des phrases complètes',
      sentence: 'Phrase',
      hearSentence: 'Écouter la phrase',
      typeSentence: 'Tapez la phrase que vous avez entendue ici...',
      sentenceCount: 'Nombre de phrases',
      hintLevel: 'Niveau d\'indice',
      hintLevel1: 'Cette phrase comporte {count} mots',
      playSpeed: 'Vitesse',
      slow: 'Lent',
      accuracyScore: 'Précision',
      partialCredit: 'Presque! {accuracy}% correct',
      sentenceReview: 'Révision des phrases',
      averageAccuracy: 'Précision moyenne',
      charactersCorrect: 'bon caractère',
      wordsCorrect: 'bons mots',
      ...
      // 句子听写
      sentenceDictationTitle: '句子听写',
      wordDictationDesc: '单词拼写练习',
      sentenceDictationDesc: '听录音写出完整句子',
      sentence: '句子',
      hearSentence: '听句子',
      typeSentence: '请输入你听到的句子...',
      sentenceCount: '句子数量',
      hintLevel: '提示等级',
      hintLevel1: '这句话有 {count} 个单词',
      playSpeed: '速度',
      slow: '慢速',
      normal: '正常',
      accuracyScore: '准确率',
      partialCredit: '差不多！准确率 {accuracy}%',
      sentenceReview: '句子回顾',
      averageAccuracy: '平均准确率',
      charactersCorrect: '字符正确',
      wordsCorrect: '单词正确',
      characters: '字符',
      check: '检查',
      totalSentences: '总句数',
